        ...
        <div class="main_section">
            <div class="all_aside">
                <div class="all_menu">
                    ...
                    <a href="<s:url action='updateInput'><s:param name='currRoleCode' value='role.roleCode'/></s:url>" class="all_menu_a"><s:text name="permissions.management.update"/></a>
                </div>
            </div>
                    ...
                    <table cellspacing="0" class="all_tab_body all_tab_bodys">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input type="hidden" id="roleCode" name="role.roleCode" value="<s:property value='role.roleCode'/>"/>
                            ...
                            <tr>
                                ...
                                <td class="all_tbs_radio">
                                    <input type="radio" name="role.status" value="0" <s:if test="role.status != '' && role.status == 0">checked</s:if>/><label><s:text name="permissions.status.enabled"/></label>
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul class="all_tbs_checkbox">
                                        <s:iterator value="%{#request.menus}" var="m">
                                            <li>
                                                <label><s:property value="#m.menuName"/></label>
                                                <input type="checkbox" name="menuCodes" onchange="validateMenus();" value="<s:property value='#m.menuCode'/>"
                                                    <s:iterator value="%{role.menus}" var="menu">
                                                        <s:if test="#menu.menuCode == #m.menuCode">checked</s:if>                                                        
                                                    </s:iterator>
                                                />
                                            </li>
                                        </s:iterator>                                       
