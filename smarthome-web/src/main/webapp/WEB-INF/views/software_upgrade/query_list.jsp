                    ...
                    <div class="all_inside">
                        ...
                        <table cellspacing="0" class="all_tab_body">
                            <thead class="all_tab_thead">
                                <tr>
                                    <th width="6%"><s:text name="softwareupgrade.code"/></th>
                                    <th width="16%"><s:text name="softwareupgrade.name"/></th>
                                    <th width="12%"><s:text name="softwareupgrade.version"/></th>
                                    <th width="9%"><s:text name="common.action.createdtime"/></th>
                                    <th width="9%"><s:text name="common.action.approvedtime"/></th>
                                    <th width="9%"><s:text name="common.action.publishedtime"/></th>
                                    <th width="5%"><s:text name="softwareupgrade.status"/></th>
