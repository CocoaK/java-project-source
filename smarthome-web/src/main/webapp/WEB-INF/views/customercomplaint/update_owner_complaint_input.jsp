...
<body>
  <form action="<s:url action='updateOwnerComplaint'/>" method="post">
  <s:hidden name="complaint.id" value="%{complaint.id}" />
  <input type="hidden" id="submitComplaint" name="submitComplaint" value="true" />
  <div class="main_section">
        <div class="all_aside">
            <div class="all_menu">
                <a href="<s:url action="queryOwnersComplaintList"/>" class="all_menu_b"><s:text name="customercomplaint.owner.list" /></a>
                <a href="#" class="all_menu_a"><s:text name="customercomplaint.update" /></a>
            </div>
        </div>
                ...
                <table cellspacing="0" class="all_tab_body all_tab_bodys">
                    <tbody>
                        <tr>
                            ...
                            <td><input type="text" name="complaint.title" value="<s:property value="complaint.title"/>" maxlength="20" class="{required:true, maxlength:20}" /></td>
                        </tr>
                        <tr>
                            <td valign="top"><dfn></dfn><s:text name="customercomplaint.content" /></td>
                            <td><textarea name="complaint.content" id="remark" class="{required:true, maxlength:500}"><s:property value="complaint.content"/></textarea></td>
                        </tr>
                    </tbody>
                </table>
