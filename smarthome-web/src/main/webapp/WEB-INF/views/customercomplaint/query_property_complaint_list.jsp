...
<body>
    <form action="<s:url action="queryPropertyComplaintList"/>" method="post">
	<div class="main_section">
    	<div class="all_aside">
        	<div class="all_menu">
            	<a href="#" class="all_menu_a"><s:text name="customercomplaint.property.list" /></a>
                ...
                <table cellspacing="0" class="all_tab_body">
                    ...
                    <tbody>
                        <s:iterator value="%{page.results}" var="complaint">
                            <tr>
                                <td  class="text_left">
                                    <a href="<s:url action="viewPropertyComplaintDetail"><s:param name="complaintId" value="#complaint.id"/></s:url>">
                                ...
                                <td>
                                    <s:if test="#complaint.processingStatus == 2">
	                                    <a class="all_hover_but" href="<s:url action="updatePropertyComplaintInput"><s:param name="complaintId" value="#complaint.id"/></s:url>">
	                                        <s:text name="common.element.action.update" />
	                                    </a>
                                        <a href="javascript:remove('<s:url action='removePropertyComplaint'></s:url>','<s:text name="common.confirm.remove"/>','<s:property value="#complaint.id"/>')" class="all_hover_but">
