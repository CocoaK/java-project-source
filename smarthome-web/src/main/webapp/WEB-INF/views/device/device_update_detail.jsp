...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
    <form action="<s:url action="updateResult"/>" method="post">
                ...
                <div class="all_inside">
                    <table cellspacing="0"
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><dfn></dfn><s:text name="device.devicename"/></td>
                                <td colspan="3">
                                <input size="20" id="device.deviceName" maxlength="40" name="device.deviceName" value="<s:property value="device.deviceName"/>" class="{required:true}"/></td>
                            </tr>
                            <tr>
                            	<td><s:text name="device.devicealias"/></td>
                                <td colspan="3"><input size="20" id="device.deviceAlias" maxlength="40" name="device.deviceAlias" value="<s:property value="device.deviceAlias" />"/></td>
                            </tr>
                            <tr>
                                <td><s:text name="device.devicestatus"/></td>
                                <td colspan="3">
                                	<s:if test='device.deviceStatus==1'><s:text name='device.devicestatus.online'/></s:if>
                                	<s:if test='device.deviceStatus==0'><s:text name='device.devicestatus.offline'/></s:if>
                                </td>
                            </tr>
                            <tr>
                            	<td><s:text name="device.ip.ipaddress"/></td>
                                <td><s:property value="device.deviceIp" /></td>
                                <td width="120"><s:text name="device.devicemac"/></td>
                                <td><s:property value="device.deviceMac" /></td>
                            </tr>
                            <tr>
                            	<td><s:text name="device.devicetype"/></td>
                                <td><s:text name="%{device.deviceType.deviceName}"/></td>
                                <td><s:text name="device.updateduser"/></td>
                                <td><s:property value="device.updatedUser" /></td>
                            </tr>
                        </tbody>
                    </table>
