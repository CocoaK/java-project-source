...
<title><s:text name="monitor.deployment" /></title>
<link href="<s:url value='/mobile/css/layout.css'/>" rel="stylesheet" />
<script type="text/javascript" src="<s:url value='/js/jquery.min.js'/>"></script>
<script type="text/javascript" src="<s:url value='/mobile/js/monitor/deployment.js'/>"></script>
</head>
<body>
	<s:include value="/WEB-INF/views/mobile/head.jsp"/>
	<div class="list_top"><s:text name="monitor.deployment" /></div>
		<input type="hidden" name="deviceCode" value="<s:property value="deviceCode" />"/>
            ...
            <div class="submit">
            	<a href="#" type="button"  id="submitControlConfirm"><s:text name="common.element.action.submit"/></a>
