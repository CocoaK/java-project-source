        ...
        <div class="main_section">
            <div class="all_aside">
                <div class="all_menu">
                    ...
                    <a href="<s:url action='appAddInput'><s:param name="componentVO.pageId" value="componentVO.pageId"/></s:url>" class="all_menu_a">新增应用</a>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                	...
                                	<input type="hidden" name="componentVO.type" value="4"/>
                                </td>
                            </tr>
                            <!-- <tr>
                                <td>组件类型</td>
