        ...
        <div class="main_section">
            <div class="all_aside">
                <div class="all_menu">
                    ...
                    <a href="<s:url action='linkAddInput'><s:param name="componentVO.pageId" value="componentVO.pageId"/></s:url>" >新增链接</a>
                    <a href="<s:url action='textAddInput'><s:param name="componentVO.pageId" value="componentVO.pageId"/></s:url>" class="all_menu_a">新增文本</a>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                	...
                                	<input type="hidden" name="componentVO.type" value="3"/>
                                </td>
                            </tr>
							<tr>
								<td>组件分组</td>
                            ...
                            <tr>
                                <td>内容</td>
                                <td>
                                	<div id="url_input"><textarea id="componentVO.url" name="componentVO.url" ></textarea></div>
                                </td>
                            </tr>
                            <tr>
                                <td>图片</td>
