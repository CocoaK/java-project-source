                        ...
                        <table cellspacing="0" class="all_tab_body">
                            <thead class="all_tab_thead">
                                <tr>
                                    ...
                                    <th width="80"><s:text name="housemgr.house.list.area"/></th>
                                    <th ><s:text name="housemgr.house.list.ownerName"/></th>
                                    <!-- <th width="50"><s:text name="housemgr.house.list.housingStatus"/></th>-->
                                    <!-- <th ><s:text name="housemgr.house.list.checkInDate"/></th> -->
                                    <th width="150">二维码</th>
                                    <th width="100">门卡</th>
                                    <th width="150px"><s:text name="common.element.title.action"/></th>
                                </tr>
                            </thead>
                            <tbody>
                                <s:iterator value="%{page.results}" var="house">
                                    <tr>
                                       ...
                                       <!--  <td>
                                        ...
                                        <td>
                                        	<a href="<s:url action="addReqInput" namespace="/qrcode">
        										<s:param name="qrcodeVO.houseId" value="#house.id"/>
        									</s:url>" class="all_hover_but">
												申请
                                            </a>
                                            <a href="<s:url action="queryList" namespace="/qrcode">
        										<s:param name="qrcodeVO.houseId" value="#house.id"/></s:url>" class="all_hover_but">
												查看
                                            </a>
                                        </td>
                                        <td>
