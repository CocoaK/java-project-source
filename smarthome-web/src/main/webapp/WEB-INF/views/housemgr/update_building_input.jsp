        ...
        <div class="main_section">
            <div class="all_aside">
                <div class="all_menu">
                    ...
                    <a href="#" class="all_menu_a"><s:text name="housemgr.building.update"/></a>
                    ...
                    <table cellspacing="0"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" size="40" name="building.code" value="<s:property value="building.code"/>" maxlength="3" class="{required: true, digits: true}" onkeyup="hideExistMsg(this);"/>
