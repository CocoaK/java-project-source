...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <form action="<s:url action="queryRegionList?print"/>" method="post">    
                ...
                <div class="main_outside">
                    <div class="all_inside">
                        <div class="all_tab_top">                            
                            ...
                            <input type="text" id="regionName" name="regionName" value="${param.regionName}" maxlength="20" class="all_tab_top_input"/>                    
                        ...
                        <table cellspacing="0" class="all_tab_body">
                            ...
                            <tbody>
                                <s:iterator value="%{page.results}" var="region">
                                    <tr>
                                        <td>
                                    	<s:property value="#region.housingDistrictInfo.name"/>&nbsp;
                                        <s:property value="#region.name"/>&nbsp;
                                    	</td>
                                        <td><s:property value="#region.housingDistrictInfo.code"/>&nbsp;
                                        <s:property value="#region.code"/>&nbsp;
                                        </td>
                                    </tr>
                                </s:iterator>
                            </tbody>
