	                 ...
	                 <table cellspacing="0" class="all_tab_body all_tab_bodys">
	                    <tbody>
                            ...
                            <tr>
                            	...
                            	<td><input id="generateCount" type="text" size="10" value="5" maxlength="2" class="{required:true, digits: true, min: 1}" /></td>
                            </tr>
                            <tr>
                                ...
                                <td class="harea_tab_body">
                                    <ol id="newRegionList">
                                        <li>
                                            ...
                                            <input name="buildingCodes" type="text" size="10" value="001" maxlength="3" class="{required: true, digits: true}" onkeyup="markUniqueEle('buildingCodes');hideExistMsg(this);"/>
                                            ...
                                            <input name="buildingNames" type="text" size="10" value="001" maxlength="10" class="{required:true, maxlength: 10}" onkeyup="markUniqueEle('buildingNames');hideExistMsg(this);"/>
                                        ...
                                        <li>
                                            <label><dfn></dfn><s:text name="housemgr.building.list.code" /></label>
                                            <input name="buildingCodes" type="text" size="10" value="002" maxlength="3" class="{required: true, digits: true}" onkeyup="markUniqueEle('buildingCodes');hideExistMsg(this);"/>
                                            <label class="error exist" style="display: none"><s:text name="housemgr.building.generate.codeRepeat"/></label>
                                            <label><dfn></dfn><s:text name="housemgr.building.list.name" /></label>
                                            <input name="buildingNames" type="text" size="10" value="002" maxlength="10" class="{required:true, maxlength: 10}" onkeyup="markUniqueEle('buildingNames');hideExistMsg(this);"/>
                                            <label class="error exist" style="display: none"><s:text name="housemgr.building.name.exist"/></label>
                                            <label><dfn></dfn><s:text name="housemgr.building.list.coordinate"/></label>
                                            <input type="hidden" name="coordinates" value=""/>
                                            <input type="text" size="10" name="coordinatesText" value="0,0" disabled="disabled" />
                                        ...
                                        <li>
                                            <label><dfn></dfn><s:text name="housemgr.building.list.code" /></label>
                                            <input name="buildingCodes" type="text" size="10" value="003" maxlength="3" class="{required: true, digits: true}" onkeyup="markUniqueEle('buildingCodes');hideExistMsg(this);"/>
                                            <label class="error exist" style="display: none"><s:text name="housemgr.building.generate.codeRepeat"/></label>
                                            <label><dfn></dfn><s:text name="housemgr.building.list.name" /></label>
                                            <input name="buildingNames" type="text" size="10" value="003" maxlength="10" class="{required:true, maxlength: 10}" onkeyup="markUniqueEle('buildingNames');hideExistMsg(this);"/>
                                            <label class="error exist" style="display: none"><s:text name="housemgr.building.name.exist"/></label>
                                            <label><dfn></dfn><s:text name="housemgr.building.list.coordinate"/></label>
                                            <input type="hidden" name="coordinates" value=""/>
                                            <input type="text" size="10" name="coordinatesText" value="0,0" disabled="disabled" />
                                        ...
                                        <li>
                                            <label><dfn></dfn><s:text name="housemgr.building.list.code" /></label>
                                            <input name="buildingCodes" type="text" size="10" value="004" maxlength="3" class="{required: true, digits: true}" onkeyup="markUniqueEle('buildingCodes');hideExistMsg(this);"/>
                                            <label class="error exist" style="display: none"><s:text name="housemgr.building.generate.codeRepeat"/></label>
                                            <label><dfn></dfn><s:text name="housemgr.building.list.name" /></label>
                                            <input name="buildingNames" type="text" size="10" value="004" maxlength="10" class="{required:true, maxlength: 10}" onkeyup="markUniqueEle('buildingNames');hideExistMsg(this);"/>
                                            <label class="error exist" style="display: none"><s:text name="housemgr.building.name.exist"/></label>
                                            <label><dfn></dfn><s:text name="housemgr.building.list.coordinate"/></label>
                                            <input type="hidden" name="coordinates" value=""/>
                                            <input type="text" size="10" name="coordinatesText" value="0,0" disabled="disabled" />
                                        ...
                                        <li>
                                            <label><dfn></dfn><s:text name="housemgr.building.list.code" /></label>
                                            <input name="buildingCodes" type="text" size="10" value="005" maxlength="3" class="{required: true, digits: true}" onkeyup="markUniqueEle('buildingCodes');hideExistMsg(this);"/>
                                            <label class="error exist" style="display: none"><s:text name="housemgr.building.generate.codeRepeat"/></label>
                                            <label><dfn></dfn><s:text name="housemgr.building.list.name" /></label>
                                            <input name="buildingNames" type="text" size="10" value="005" maxlength="10" class="{required:true, maxlength: 10}" onkeyup="markUniqueEle('buildingNames');hideExistMsg(this);"/>
                                            <label class="error exist" style="display: none"><s:text name="housemgr.building.name.exist"/></label>
                                            <label><dfn></dfn><s:text name="housemgr.building.list.coordinate"/></label>
                                            <input type="hidden" name="coordinates" value=""/>
                                            <input type="text" size="10" name="coordinatesText" value="0,0" disabled="disabled" />
