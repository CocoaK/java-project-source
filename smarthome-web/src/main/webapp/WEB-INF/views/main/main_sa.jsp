	...
	<div class="main_section">
    	<div class="main_aside">
            ...
            <ul class="main_box_body">
            	<li><strong class="main_ico_00"></strong><span><s:text name="owner.count"/>:<i id="liverCount"></i></span></li>
                <li><strong class="main_ico_01"></strong><span><s:text name="sys.district.count"/>:<i id="districtCount"></i></span></li>
                <!-- <li><strong class="main_ico_02"></strong><span><s:text name="user.online.count"/>:<i id="onlineUserCount"></i></span></li> -->
                <li><strong class="main_ico_03"></strong><span><s:text name="device.online.count"/>:<i id="onlineDeviceCount"></i></span></li>
                <li><strong class="main_ico_04"></strong><span><s:text name="sys.today.infocount"/>:<i id="todayInfoCount"></i></span></li>
                <li><strong class="main_ico_05"></strong><span><s:text name="user.complaint.count"/>:<i id="complaintCount"></i></span></li>
                <li><strong class="main_ico_06"></strong><span><s:text name="sys.goods.count"/>:<i></i></span></li>
        	...
        	<div class="main_inside">
            	<div class="main_tab_top">
                    <ul>
                        ...
                        <li onclick="getTab('tab2')" id="li_tab2"><s:text name="recent.software"/></li>
                ...
                <div class="main_tab_body">
                    ...
                    <div class="none" id="div_tab1">
                        <ul id="tab1"></ul>
                        <p><a href="<%=path %>customercomplaint/queryComplaintList.action"><s:text name="main.page.more"/>&raquo;</a></p>
                    </div>
                    <div class="none" id="div_tab2">
                       	<ul id="tab2"></ul>
                        <p><a href="<%=path %>softwareUpgrade/queryList.action"><s:text name="main.page.more"/>&raquo;</a></p>
                    </div>
                    <div class="none" id="div_tab3">
                        <ul id="tab3"></ul>
                        <p><a href="<%=path %>ad/queryList.action"><s:text name="main.page.more"/>&raquo;</a></p>
                    </div>
                </div>
                <div class="main_tab_top">
                    <ul>
                        <li class="selecteds" onclick="getTab('tab4')" id="li_tab4"><s:text name="recent.push"/></li>
