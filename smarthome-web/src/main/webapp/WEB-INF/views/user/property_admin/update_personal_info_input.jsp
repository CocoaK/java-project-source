                    ...
                    <table cellspacing="0" class="all_tab_body all_tab_bodys">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="mainput"><s:text name="common.title.districtname"/></td>
                                <td class="mainput">
                                    <s:property value='user.districtName'/>
                                </td>                              
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><input type="text" maxlength="25" name="user.degree" class="{maxlength:25}" value="<s:property value='user.degree'/>" /></td>
                                <td><s:text name="common.title.major"/></td>
                                <td><input type="text" maxlength="25" name="user.major" class="{maxlength:25}" value="<s:property value='user.major'/>" /></td>
                            </tr>
                            <tr>
                                <td><s:text name="user.intro"/></td>
                                <td colspan="3"><textarea name="user.intro" class="{maxlength:100}"><s:property value='user.intro'/></textarea></td>
                            </tr>                                                                                                                                          
                        </tbody>
                        <thead>
                            <tr>
