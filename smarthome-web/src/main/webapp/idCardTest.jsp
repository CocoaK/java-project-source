		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td width="100%" colspan="3">
					<p align="center">
						<b><font color="#5555FF" size="6"> </font>
						</b>
				</td>
			</tr>
			<tr>
	...
	<form name="MyForm"  method=post>
		<table border="0" width="100%" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<td width="11%">
					<p align="right">
						<font color="#FF0000"><b>身份证号：</b>
						</font>
					</p></td>
				<center>
					<td width="41%" colspan="2"><input type="text" name="CardNo"
						size="49" class=Input2 style="color: #FF0000">
					</td>
					<td width="28%"></td>
				</center>
			</tr>
			...
			<tr>
				...
				<td width="11%">
					<p align="right">期限起始：</p></td>
				<center>
					<td width="41%" colspan="2"><input type="text"
						name="ActivityLFrom" size="49" class=Input2></td>
					<td width="28%"></td>
				</center>
			</tr>
			<tr>
				...
				<center>
					<center>
						<center>
							<td width="41%" colspan="2"><input type="text"
								name="ActivityLTo" size="49" class=Input2></td>
							<td width="28%"></td>
						</center>
					</center>
				</center>
			...
			<tr>
				...
				<td width="11%">
					<p align="right">照片路径：</p></td>
				<td width="41%" colspan="2"><input type="text" name="PhotoPath"
					value="C:\" size="49" class=Input2></td>
				<center>
					<center>
						<center>
							<td width="28%"></td>
					...
					<center>
						<center>
							<td width="41%" colspan="2"><textarea rows="4"
									name="PhotoBuffer" cols="47" class=MultiEditBox></textarea></td>
							<td width="28%"></td>
						</center>
					</center>
				</center>
			...
			<tr>
				...
				<td width="41%" colspan="2"><input type="text"
					...
					name="submit" value="保存读卡结果" onclick="saveCardInfo();"></td>
				<td width="28%"></td>
			</tr>
