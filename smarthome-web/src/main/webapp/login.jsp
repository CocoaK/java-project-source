...
<script type="text/javascript">
    ...
    function langChange(v){
        locationAction("<s:url action='changeLocale' namespace='/login'/>?selectedLanguage="+v);
    }
...
<body>
    <form action="<s:url action='go' namespace='/login'/>" method="post">
        <div class="login_header">
            <div class="login_header_01">
            ...
            <div class="login_header_02"></div>
            <div class="login_header_03"></div>
        </div>
