package com.biencloud.smarthome.service.sip.model;
...
public class SipRegister{
	    ...
	    private Integer type;	////type=1门口机,type=2围墙机,type=3手机
	    ...
	    public SipRegister(String username, String domain, String password,
			...
			this.domain = (StringUtils.isEmpty(domain)) ? username + "@localhost" : domain;;
			this.password = password;
			this.emailAddress = (StringUtils.isEmpty(emailAddress)) ? username + "@localhost" : emailAddress;
	    ...
	    public SipRegister(String username, String domain, String password,
				String emailAddress,Integer type) {
			super();
			this.username = username;
			this.domain = (StringUtils.isEmpty(domain)) ? username + "@localhost" : domain;;
			this.password = password;
