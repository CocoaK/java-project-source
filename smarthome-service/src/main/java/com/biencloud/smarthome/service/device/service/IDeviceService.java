...
public interface IDeviceService extends IService<Device, String> {
	 ...
	 * @desc   @param areaNo
	 * @desc   @param regionNo
	 * @desc   @param buildingNo
	 * @desc   @param unitNo
	 * @desc   @param houseNo
	 * @desc   @param deviceType
	 * @desc   @param position
	 * @desc   @param existDeviceId
	 * @desc   @return
	 * @return boolean
	 * @param areaNo
	 * @param regionNo
	 ...
	 * @return
	 */
	boolean isRepeatDevicePosition(String areaNo, String regionNo,
			String buildingNo, String unitNo, String houseNo,
			String deviceType, String position, String existDeviceId);
	 ...
	 * @return
	 */
	List<Device> queryNotIndoorDevice(String areaNo, String regionNo,
			String buildingNo, String unitNo, String houseNo, String position,String deviceType);
}
