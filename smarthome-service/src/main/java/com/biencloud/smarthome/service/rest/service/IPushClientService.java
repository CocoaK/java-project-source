...
//	void sendAndroidJpush(String alert,String title,Map<String,String> extras,List<String> registrationIds, JPushClient jPushClient);
	...
	void sendIosPushIntercom(String alert, String sound, List<String> tokens,
			int badge);
	
	void sendIosPushIntercom(String alert, String sound, String deviceNo,
			int badge);
	 ...
	 * @return 
	 */
	List<String> getTokenListByDeviceNo(String deviceNo,String tokenType);
	 ...
	 * @param registrationIds 推送目标id
	 */
	void sendAndroidJpushIntercom(String deviceNo,String alert,String title,String sound,JPushClient jPushClient);
	 ...
	 * @param username
	 */
	void pushIntercom(String alert, String title, String username);
