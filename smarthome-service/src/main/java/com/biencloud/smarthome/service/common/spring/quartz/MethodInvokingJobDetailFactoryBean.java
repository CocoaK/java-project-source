...
public class MethodInvokingJobDetailFactoryBean implements FactoryBean,
	 ...
	 * <li>jobDetail.jobClass is set to MethodInvokingJob.class or
	 ...
	 * <li>jobDetail.jobDataMap["targetClass"] is set to
	 ...
	 * <code>{beanName}</code>
	 * <li>INFO: Created JobDetail: <code>{jobDetail}</code>; targetClass:
	 * <code>{targetClass}</code>; targetMethod: <code>{targetMethod}</code>;
	 * <li>DEBUG: end
	 * </ul>
	 * 
	 ...
	 * "targetMethod".<br>
	 * - It uses the value of the <code>targetClass</code> entry to get the
	...
	public static class MethodInvokingJob implements Job {
		 ...
		 * then targetMethod must be a static method.<br>
		 ...
		 * Serializable when <code>concurrent</code> is set to false.<br>
		 ...
		 * arguments must be Serializable when <code>concurrent</code> is set to
		 * false.
		 * <p>
		...
		public void execute(JobExecutionContext context)
			...
			try {
				...
				Object[] arguments = (Object[]) context.getMergedJobDataMap()
						.get("arguments");
				...
				logger.info("Invoking: "
						+ methodInvoker.getPreparedMethod().toGenericString());
