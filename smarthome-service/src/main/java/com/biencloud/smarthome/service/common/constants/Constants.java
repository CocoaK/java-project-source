...
public class Constants {
	...
	/** 云对讲极光推送appKey*/
	public static final String PUSH_APP_KEY_JPUSH_INTERCOM = "4e9fcfa56ffc363a84c2a8f5";
	
	/** 云对讲极光推送Master Secret*/
	public static final String PUSH_MASTER_SECRET_JPUSH_INTERCOM = "cb0851f0bd8964eaba7bece6";
	
	/** 推送重试次数 */
	public static final Integer PUSH_RETRY_COUNT = 3;
	/** IOS推送证书目录 */
	public static final String IOS_SERT_DIR= "ioscert/"; 
	/** Skeeper IOS推送证书名称*/
	...
	/** 云对讲 IOS推送证书名称*/
	public static final String IOS_PUSH_CERT_NAME_INTERCOM = "intercomPushCert.p12";
    ...
    /** 安卓1byone推送 title */
    public static final String PUSH_TITLE_1BYONE = "Onekeeper";
    ...
    /** 版本查询类型:MCU */
    public static final String VERSION_TYPE_MCU = "9";
    
    /** 楼宇可视对讲推送铃声 */
    public static final String PUSH_SOUND_INTERCOM = "incoming.wav";
}
