...
//			getPushService().insertPush(push);	//推送坐标修改
	...
	@Override
	public boolean isRepeatDevicePosition(String areaNo, String regionNo, String buildingNo, String unitNo,String houseNo, String deviceType,
			String position, String existDeviceId) {
		boolean isRepeat = false;
	...
	@Override
	public List<Device> queryNotIndoorDevice(String areaNo, String regionNo, String buildingNo, String unitNo,String houseNo, String position,String deviceType) {
		StringBuilder sb = new StringBuilder();
		List<Device> list = null;
		if (areaNo != null&&position!=null) {
			sb.append("from Device where housingDistrictInfo.code='" + areaNo + "'");
