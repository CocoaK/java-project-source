...
CREATE TABLE `t_charge_calmode` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='收费计算方式';
...
CREATE TABLE `t_charge_data` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID主键',
  `owner_name` varchar(10) NOT NULL COMMENT '业主姓名',
  `roomId` bigint(20) NOT NULL COMMENT '房号',
  `homeId` bigint(20) NOT NULL COMMENT '楼栋名称',
  `total_money` float NOT NULL COMMENT '总金额',
  `monetaryUnit` varchar(10) NOT NULL COMMENT '货币单位',
  ...
  `comId` bigint(20) NOT NULL COMMENT '所属小区',
  ...
  CONSTRAINT `comId_system_group` FOREIGN KEY (`comId`) REFERENCES `t_system_group` (`group_no`),
  CONSTRAINT `homeId_building_cell_info` FOREIGN KEY (`homeId`) REFERENCES `t_hm_building_cell_info` (`ID`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='收费数据表';
...
CREATE TABLE `t_charge_detail` (
  ...
  `charge_time` char(10) DEFAULT NULL COMMENT '缴费时间',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='收费清单列表';
...
CREATE TABLE `t_charge_monetaryunit` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='收费货币单位表';
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='收费项目表';

-- ----------------------------
-- Records of t_charge_type
-- ----------------------------
INSERT INTO `t_charge_type` VALUES ('8', '水费', '3', '2.3', '3', null, '水费', null, null, null, '立方');
INSERT INTO `t_charge_type` VALUES ('9', '物业费', '3', '150', '3', null, '物业费', null, null, null, '年');
...
CREATE TABLE `t_charge_type_result` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID主键',
  `chargeTypeId` bigint(20) NOT NULL COMMENT '收费项目名称',
  ...
  `play_money` float NOT NULL COMMENT '缴费金额',
  `remark` text COMMENT '备注',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='收费项目结果表';
...
INSERT INTO `t_device_no` VALUES ('8', 'g20120511165454I', null, null);
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ԪֵķϢ';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='СϢ';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='򻮷ֵ¥Ϣ';
