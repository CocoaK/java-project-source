...
<div class="main_section">
        <div class="all_aside">
            <div class="all_menu">
                ...
                <a href="#" class="all_menu_a"><s:text name="monitor.remoteApplianceControl.scene" /></a>
        ...
        <div class="main_outside">
            ...
            <div class="all_tab_butb"><input type="button" onclick="doSceneControl()" id="sceneControlConfirm" value="<s:text name="common.element.action.submit"/>" /></div>
        </div>
    </div>
    </form>
</body>
