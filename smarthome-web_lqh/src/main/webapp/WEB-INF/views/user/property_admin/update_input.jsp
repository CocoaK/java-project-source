        ...
        <div class="main_section">
            <div class="all_aside">
                <div class="all_menu">
                    ...
                    <a href="<s:url action='updateInput'><s:param name='currUserId' value='user.userId'/></s:url>" class="all_menu_a"><s:text name="pauser.management.update"/></a>
                </div>
            </div>
            <div class="main_outside">
                <div class="all_inside">
                    ...
                    <div class="all_tab_butb"><input type="button" onclick="savePaUser('')" value="<s:text name='common.element.action.confirm.update' />" /></div>                    
