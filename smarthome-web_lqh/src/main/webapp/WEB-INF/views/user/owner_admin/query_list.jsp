    ...
    <body>
        <form action="<s:url action='queryList'/>" method="post">    
            <div class="main_section">
                <div class="all_aside">
                    <div class="all_menu">
                        <a href="<s:url action='queryList'/>" class="all_menu_a"><s:text name="owneruser.management.list"/></a>
                        ...
                        <table cellspacing="0" class="all_tab_body">
                            ...
                            <tbody>
                                <s:iterator value="%{page.results}" var="user">
                                    <tr>
                                    	<td><s:property value="#user.houseName"/></td>
                                    	<td><s:property value="#user.unitName"/></td>
                                    	<td><s:property value="#user.building"/></td>
                                    	<td><s:property value="#user.areaName"/></td>
                                        <td>
