                    ...
                    <table cellspacing="0" class="all_tab_body all_tab_bodys">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td width="120">系统用户类型</td>
                                <td>
                                    <select name="user.userType">
                                        <option value="03" <s:if test="user.userType != '' && user.userType == 0">selected</s:if>>楼宇</option>
                                        <option value="04" <s:if test="user.userType != '' && user.userType == 0">selected</s:if>>终端</option>
                                    </select>                                      
                                </td>
                            </tr>
                            <tr>
