            ...
            <div class="main_section">
                <div class="all_aside">
                    <div class="all_menu">
                        ...
                        <a href="<s:url action='updateInput'><s:param name='adId' value='ad.adId'/></s:url>" class="all_menu_a"><s:text name="ad.management.app.update"/></a>
                    </div>
                </div>
                <div class="main_outside">
                    <div class="all_inside">
                        <s:include value="/WEB-INF/views/ad/include_save_app_ad.jsp"/>
                        <div class="all_tab_butb"><input type="button" onclick="saveAppAd();" value="<s:text name='common.element.action.confirm.update' />" /></div>
