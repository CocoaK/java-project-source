...
<body>
    <form action="<s:url action="queryOwnerComplaintList"/>" method="post">
                ...
                <table cellspacing="0" class="all_tab_body">
                    ...
                    <tbody>
                        <s:iterator value="%{page.results}" var="complaint">
                            <tr>
                                <td class="text_left">
                                    <a href="<s:url action="viewOwnerComplaintDetail"><s:param name="complaintId" value="#complaint.id"/></s:url>">
                                ...
                                <td>
                                    <s:if test="#complaint.processingStatus == 0">
	                                    <a class="all_hover_but" href="<s:url action="viewOwnerComplaintDetail"><s:param name="complaintId" value="#complaint.id"/></s:url>">
