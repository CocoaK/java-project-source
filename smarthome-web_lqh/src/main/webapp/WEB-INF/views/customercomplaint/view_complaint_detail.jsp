...
<body>
  <form action="<s:url action="replyPropertyComplaintSuggestion"/>" method="post">
  <s:hidden name="complaintId" value="%{complaintId}" />
  <div class="main_section">
        <div class="all_aside">
            <div class="all_menu">
                <a href="<s:url action="queryComplaintList"/>" class="all_menu_b"><s:text name="customercomplaint.system.list" /></a>
        ...
        <div class="main_outside">
            <div class="all_inside">
                <table cellspacing="0" class="all_tab_body all_tab_bodys">
                    ...
                    <thead>
                        <tr>
                            <th colspan="4" class="font_left"><s:text name="customercomplaint.suggestion" /></th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td colspan="2"><textarea name="suggestion" class="{required:true, maxlength:500}"></textarea></td>
                        </tr>
                    </tbody>
                    </s:if>
                </table>
                <s:if test="complaint.processingStatus == 0">
                    <div class="all_tab_butb">
                        <input type="submit" value="<s:text name="common.element.action.process" />" />
                    </div>
                </s:if>
            </div>
        </div>
