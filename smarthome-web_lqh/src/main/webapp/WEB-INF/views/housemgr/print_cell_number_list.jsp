...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <form action="<s:url action="queryCellList?print"/>" method="post">    
                        ...
                        <table cellspacing="0" class="all_tab_body">
                            ...
                            <tbody>
                                <s:iterator value="%{page.results}" var="cell">
                                    <tr>
                                        <td>
                                    	<s:property value="#cell.THmRegionBuildingInfo.THmHousingDistrictRegionInfo.housingDistrictInfo.name"/>&nbsp;
                                        <s:property value="#cell.THmRegionBuildingInfo.THmHousingDistrictRegionInfo.name"/>&nbsp;
                                        <s:property value="#cell.THmRegionBuildingInfo.name"/>&nbsp;
                                        <s:property value="#cell.name"/>&nbsp;
                                    	</td>
                                        <td><s:property value="#cell.THmRegionBuildingInfo.THmHousingDistrictRegionInfo.housingDistrictInfo.code"/>&nbsp;
                                        <s:property value="#cell.THmRegionBuildingInfo.THmHousingDistrictRegionInfo.code"/>&nbsp;
                                        <s:property value="#cell.THmRegionBuildingInfo.code"/>&nbsp;
                                        <s:property value="#cell.code"/>&nbsp;
                                        </td>
                                    </tr>
                                </s:iterator>                       
                            </tbody>
