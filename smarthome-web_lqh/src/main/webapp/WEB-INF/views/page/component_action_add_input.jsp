...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <form action="<s:url action="add"/>" method="post" enctype="multipart/form-data">
        <div class="main_section">
            <div class="all_aside">
                <div class="all_menu">
                   	<a href="<s:url action='actionAddInput'><s:param name="componentVO.pageId" value="componentVO.pageId"/></s:url>" class="all_menu_a">新增动作</a>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                	...
                                	<input type="hidden" name="componentVO.type" value="2"/>
                                </td>
                            </tr>
                            <!-- <tr>
                                <td>组件类型</td>
